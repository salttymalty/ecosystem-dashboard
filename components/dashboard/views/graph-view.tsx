  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-3 text-center">
        ...
        >
          <div className="text-2xl font-display font-semibold text-foreground">9</div>
        ...
        >
          <div className="text-2xl font-display font-semibold text-foreground">16</div>
        ...
        >
          <div className="text-2xl font-display font-semibold text-foreground">28</div>
